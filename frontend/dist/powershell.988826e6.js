...
})({"1B6p2":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "e375a0f4988826e6";
"use strict";
...
},{}],"ddMQo":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "powerShell", ()=>powerShell);
...
function tokenBase(stream, state) {
    ...
    for(var key in grammar){
        if (stream.match(grammar[key])) return key;
    }
    var ch = stream.next();
    // single-quote string
    ...
    if (ch === '@') {
        ...
        else if (stream.peek().match(varNames)) // splatted variable
...
function tokenInterpolation(stream, state, parentTokenize) {
    if (stream.match('$(')) {
        ...
        state.returnStack.push({
            /*jshint loopfunc:true */ shouldReturnFrom: function(state) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["1B6p2"], null, "parcelRequire10c2", {})

//# sourceMappingURL=powershell.988826e6.js.map
