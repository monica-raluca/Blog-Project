...
})({"as169":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "b92d0a855753a5f9";
"use strict";
...
},{}],"jMgpK":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "wast", ()=>wast);
parcelHelpers.export(exports, "wastLanguage", ()=>wastLanguage);
...
const wastLanguage = /*@__PURE__*/ (0, _language.LRLanguage).define({
    name: "wast",
    parser: /*@__PURE__*/ parser.configure({
        props: [
            /*@__PURE__*/ (0, _language.indentNodeProp).add({
                App: /*@__PURE__*/ (0, _language.delimitedIndent)({
                    closing: ")",
                    align: false
                })
            }),
            /*@__PURE__*/ (0, _language.foldNodeProp).add({
                App: (0, _language.foldInside),
                BlockComment (tree) {
                    return {
                        from: tree.from + 2,
                        to: tree.to - 2
...
function wast() {
    return new (0, _language.LanguageSupport)(wastLanguage);
}

},{"@codemirror/language":"dx7XI","@lezer/highlight":"5AwBv","@lezer/lr":"hqnf3","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["as169"], null, "parcelRequire10c2", {})

//# sourceMappingURL=dist.5753a5f9.js.map
