...
})({"2JRtU":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "45af3f70bff1f901";
"use strict";
...
},{}],"kYYwC":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "cpp", ()=>cpp);
parcelHelpers.export(exports, "cppLanguage", ()=>cppLanguage);
var _cpp = require("@lezer/cpp");
var _language = require("@codemirror/language");
/**
A language provider based on the [Lezer C++
parser](https://github.com/lezer-parser/cpp), extended with
highlighting and indentation information.
*/ const cppLanguage = /*@__PURE__*/ (0, _language.LRLanguage).define({
    name: "cpp",
    parser: /*@__PURE__*/ (0, _cpp.parser).configure({
        props: [
            /*@__PURE__*/ (0, _language.indentNodeProp).add({
                ...
                BlockComment: ()=>null,
                CompoundStatement: /*@__PURE__*/ (0, _language.delimitedIndent)({
                    closing: "}"
                }),
            ...
            /*@__PURE__*/ (0, _language.foldNodeProp).add({
                "DeclarationList CompoundStatement EnumeratorList FieldDeclarationList InitializerList": (0, _language.foldInside),
                BlockComment (tree) {
                    return {
                        from: tree.from + 2,
                        to: tree.to - 2
...
*/ function cpp() {
    return new (0, _language.LanguageSupport)(cppLanguage);
}

},{"@lezer/cpp":"3MAA6","@codemirror/language":"dx7XI","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3MAA6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const rawString = new (0, _lr.ExternalTokenizer)((input)=>{
...
const fallback = new (0, _lr.ExternalTokenizer)((input)=>{
    if (input.next == GreaterThan) // Provide a template-args-closing token when the next characters
...
const cppHighlighting = (0, _highlight.styleTags)({
    "typedef struct union enum class typename decltype auto template operator friend noexcept namespace using requires concept import export module __attribute__ __declspec __based": (0, _highlight.tags).definitionKeyword,
    "extern MsCallModifier MsPointerModifier extern static register thread_local inline const volatile restrict _Atomic mutable constexpr constinit consteval virtual explicit VirtualSpecifier Access": (0, _highlight.tags).modifier,
    "if else switch for while do case default return break continue goto throw try catch": (0, _highlight.tags).controlKeyword,
    "co_return co_yield co_await": (0, _highlight.tags).controlKeyword,
    "new sizeof delete static_assert": (0, _highlight.tags).operatorKeyword,
    "NULL nullptr": (0, _highlight.tags).null,
    this: (0, _highlight.tags).self,
    "True False": (0, _highlight.tags).bool,
    "TypeSize PrimitiveType": (0, _highlight.tags).standard((0, _highlight.tags).typeName),
    TypeIdentifier: (0, _highlight.tags).typeName,
    FieldIdentifier: (0, _highlight.tags).propertyName,
    "CallExpression/FieldExpression/FieldIdentifier": (0, _highlight.tags).function((0, _highlight.tags).propertyName),
    "ModuleName/Identifier": (0, _highlight.tags).namespace,
    "PartitionName": (0, _highlight.tags).labelName,
    StatementIdentifier: (0, _highlight.tags).labelName,
    "Identifier DestructorName": (0, _highlight.tags).variableName,
    "CallExpression/Identifier": (0, _highlight.tags).function((0, _highlight.tags).variableName),
    "CallExpression/ScopedIdentifier/Identifier": (0, _highlight.tags).function((0, _highlight.tags).variableName),
    "FunctionDeclarator/Identifier FunctionDeclarator/DestructorName": (0, _highlight.tags).function((0, _highlight.tags).definition((0, _highlight.tags).variableName)),
    NamespaceIdentifier: (0, _highlight.tags).namespace,
    OperatorName: (0, _highlight.tags).operator,
    ...
    "RawString SystemLibString": (0, _highlight.tags).special((0, _highlight.tags).string),
    CharLiteral: (0, _highlight.tags).character,
    EscapeSequence: (0, _highlight.tags).escape,
    "UserDefinedLiteral/Identifier": (0, _highlight.tags).literal,
    PreProcArg: (0, _highlight.tags).meta,
    "PreprocDirectiveName #include #ifdef #ifndef #if #define #else #endif #elif": (0, _highlight.tags).processingInstruction,
    MacroName: (0, _highlight.tags).special((0, _highlight.tags).name),
...
},{"@lezer/lr":"hqnf3","@lezer/highlight":"5AwBv","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["2JRtU"], null, "parcelRequire10c2", {})

//# sourceMappingURL=dist.bff1f901.js.map
