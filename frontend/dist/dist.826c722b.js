...
})({"3z45o":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "a8e82bb7826c722b";
"use strict";
...
},{}],"atiUJ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "rust", ()=>rust);
parcelHelpers.export(exports, "rustLanguage", ()=>rustLanguage);
var _rust = require("@lezer/rust");
var _language = require("@codemirror/language");
/**
A syntax provider based on the [Lezer Rust
parser](https://github.com/lezer-parser/rust), extended with
highlighting and indentation information.
*/ const rustLanguage = /*@__PURE__*/ (0, _language.LRLanguage).define({
    name: "rust",
    parser: /*@__PURE__*/ (0, _rust.parser).configure({
        props: [
            /*@__PURE__*/ (0, _language.indentNodeProp).add({
                IfExpression: /*@__PURE__*/ (0, _language.continuedIndent)({
                    except: /^\s*({|else\b)/
                }),
                "String BlockComment": ()=>null,
                "AttributeItem": (cx)=>cx.continue(),
                "Statement MatchArm": /*@__PURE__*/ (0, _language.continuedIndent)()
            }),
            /*@__PURE__*/ (0, _language.foldNodeProp).add((type)=>{
                if (/(Block|edTokens|List)$/.test(type.name)) return 0, _language.foldInside;
...
*/ function rust() {
    return new (0, _language.LanguageSupport)(rustLanguage);
}

},{"@lezer/rust":"2p9E1","@codemirror/language":"dx7XI","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"2p9E1":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const literalTokens = new (0, _lr.ExternalTokenizer)((input, stack)=>{
    if (isNum(input.next)) {
        let isFloat = false;
        do input.advance();
        ...
        if (input.next == Dot) {
            isFloat = true;
            input.advance();
            if (isNum(input.next)) do input.advance();
            while (isNum_(input.next));
            else if (input.next == Dot || input.next > 0x7f || /\w/.test(String.fromCharCode(input.next))) return;
        }
...
const closureParam = new (0, _lr.ExternalTokenizer)((input)=>{
    if (input.next == Pipe) input.acceptToken(closureParamDelim, 1);
});
const tpDelim = new (0, _lr.ExternalTokenizer)((input)=>{
    if (input.next == LessThan) input.acceptToken(tpOpen, 1);
    else if (input.next == GreaterThan) input.acceptToken(tpClose, 1);
});
const rustHighlighting = (0, _highlight.styleTags)({
    "const macro_rules struct union enum type fn impl trait let static": (0, _highlight.tags).definitionKeyword,
    "mod use crate": (0, _highlight.tags).moduleKeyword,
    "pub unsafe async mut extern default move": (0, _highlight.tags).modifier,
    "for if else loop while match continue break return await": (0, _highlight.tags).controlKeyword,
    "as in ref": (0, _highlight.tags).operatorKeyword,
    "where _ crate super dyn": (0, _highlight.tags).keyword,
    "self": (0, _highlight.tags).self,
    String: (0, _highlight.tags).string,
    Char: (0, _highlight.tags).character,
    RawString: (0, _highlight.tags).special((0, _highlight.tags).string),
    ...
    BoundIdentifier: (0, _highlight.tags).definition((0, _highlight.tags).variableName),
    "FunctionItem/BoundIdentifier": (0, _highlight.tags).function((0, _highlight.tags).definition((0, _highlight.tags).variableName)),
    LoopLabel: (0, _highlight.tags).labelName,
    ...
    Lifetime: (0, _highlight.tags).special((0, _highlight.tags).variableName),
    ScopeIdentifier: (0, _highlight.tags).namespace,
    TypeIdentifier: (0, _highlight.tags).typeName,
    "MacroInvocation/Identifier MacroInvocation/ScopedIdentifier/Identifier": (0, _highlight.tags).macroName,
    "MacroInvocation/TypeIdentifier MacroInvocation/ScopedIdentifier/TypeIdentifier": (0, _highlight.tags).macroName,
    ...
    "Attribute/...": (0, _highlight.tags).meta
});
// This file was generated by lezer-generator. You probably shouldn't edit it.
...
},{"@lezer/lr":"hqnf3","@lezer/highlight":"5AwBv","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["3z45o"], null, "parcelRequire10c2", {})

//# sourceMappingURL=dist.826c722b.js.map
