...
})({"9edaS":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "0692d696e908c8cf";
"use strict";
...
},{}],"3bJjD":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "pug", ()=>pug);
var _javascriptJs = require("./javascript.js");
var ATTRS_NEST = {
    '{': '}',
    '(': ')',
    '[': ']'
...
class State {
    constructor(indentUnit){
        ...
        this.jsState = (0, _javascriptJs.javascript).startState(indentUnit);
        this.restOfLine = '';
    ...
    copy() {
        ...
        res.jsState = ((0, _javascriptJs.javascript).copyState || defaultCopyState)(this.jsState);
...
function javaScript(stream, state) {
    ...
    if (state.javaScriptLine) {
        ...
        var tok = (0, _javascriptJs.javascript).token(stream, state.jsState);
...
function interpolationContinued(stream, state) {
    if (state.isInterpolating) {
        ...
        return (0, _javascriptJs.javascript).token(stream, state.jsState) || true;
    }
}
    ...
    if (state.isAttrs) {
        ...
        if (state.inAttributeName && stream.match(/^[^=,\)!]+/)) {
            if (stream.peek() === '=' || stream.peek() === '!') {
                ...
                state.jsState = (0, _javascriptJs.javascript).startState(2);
...
function restOfLine(stream, state) {
    if (stream.sol()) // if restOfLine was set at end of line, ignore it
    state.restOfLine = '';
    if (state.restOfLine) {
        stream.skipToEnd();
...
},{"./javascript.js":"axLQb","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["9edaS"], null, "parcelRequire10c2", {})

//# sourceMappingURL=pug.e908c8cf.js.map
