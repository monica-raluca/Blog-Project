...
})({"g8y9m":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "5c09788750c30535";
"use strict";
...
},{}],"b2dK7":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "vue", ()=>vue);
parcelHelpers.export(exports, "vueLanguage", ()=>vueLanguage);
...
const parser = /*@__PURE__*/ (0, _lr.LRParser).deserialize({
    ...
    tokenizers: [
        6,
        7,
        /*@__PURE__*/ new (0, _lr.LocalTokenGroup)("b~RP#q#rU~XP#q#r[~aOT~~", 17, 4),
        /*@__PURE__*/ new (0, _lr.LocalTokenGroup)("!k~RQvwX#o#p!_~^TU~Opmq!]m!^;'Sm;'S;=`!X<%lOm~pUOpmq!]m!]!^!S!^;'Sm;'S;=`!X<%lOm~!XOU~~![P;=`<%lm~!bP#o#p!e~!jOk~~", 72, 2),
        /*@__PURE__*/ new (0, _lr.LocalTokenGroup)("[~RPwxU~ZOp~~", 11, 15),
        /*@__PURE__*/ new (0, _lr.LocalTokenGroup)("[~RPrsU~ZOn~~", 11, 14),
        /*@__PURE__*/ new (0, _lr.LocalTokenGroup)("!e~RQvwXwx!_~^Tc~Opmq!]m!^;'Sm;'S;=`!X<%lOm~pUOpmq!]m!]!^!S!^;'Sm;'S;=`!X<%lOm~!XOc~~![P;=`<%lm~!dOt~~", 66, 35),
        /*@__PURE__*/ new (0, _lr.LocalTokenGroup)("!e~RQrsXvw^~^Or~~cTb~Oprq!]r!^;'Sr;'S;=`!^<%lOr~uUOprq!]r!]!^!X!^;'Sr;'S;=`!^<%lOr~!^Ob~~!aP;=`<%lr~", 66, 33)
    ],
    topRules: {
        "Content": [
            0,
...
const baseParser = /*@__PURE__*/ parser.configure({
    props: [
        /*@__PURE__*/ (0, _highlight.styleTags)({
            ...
            VueAttributeName: (0, _highlight.tags).keyword,
            Identifier: (0, _highlight.tags).variableName,
            "AttributeValue ScriptAttributeValue": (0, _highlight.tags).attributeValue,
...
const attrParser = /*@__PURE__*/ baseParser.configure({
    wrap: /*@__PURE__*/ (0, _common.parseMixed)((node, input)=>node.name == "AttributeScript" ? exprMixed : null),
    top: "Attribute"
});
const textMixed = {
    parser: textParser
...
function makeVue(base) {
    return base.configure({
        dialect: "selfClosing",
        wrap: (0, _common.parseMixed)(mixVue)
    }, "vue");
}
/**
...
*/ function vue(config = {}) {
    ...
    return new (0, _language.LanguageSupport)(base.language == baseHTML.language ? vueLanguage : makeVue(base.language), [
        base.support,
...
},{"@codemirror/language":"dx7XI","@codemirror/lang-html":"5njbQ","@codemirror/lang-javascript":"3QU1O","@lezer/highlight":"5AwBv","@lezer/common":"6f22T","@lezer/lr":"hqnf3","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["g8y9m"], null, "parcelRequire10c2", {})

//# sourceMappingURL=dist.50c30535.js.map
